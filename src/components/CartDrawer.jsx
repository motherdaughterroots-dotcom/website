                    ...
                    return (
                      <div key={item.id} className="flex gap-4 pb-5 border-b border-[var(--color-cream-line)]/60">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {item.kind === 'combo' && item.discountPercent > 0 && (
                            <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-full bg-[var(--color-olive)]/10 text-[var(--color-olive)] text-[10px] font-semibold">
                              <Tag size={9} /> Combo {item.discountPercent}% OFF
                            </span>
                          )}
